...
const dialogs = [
  ...
  [
    'bean',
    '[default]Because everyone is using[/default] [obxia]obxia[/obxia] [default]now![/default]',
  ],
  ...
  ['bean', '[default]Particles![/default]'],
  ...
  ['bean', '[default]And much more![/default]'],
...
function startWriting(dialog, char) {
  ...
  const writing = loop(0.05, () => {
    txt.letterCount = Math.min(txt.letterCount + 1, txt.renderedText.length);
