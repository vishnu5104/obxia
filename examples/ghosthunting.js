...
// Hallway
add([pos(20, 20), rect(600, 100), color(rgb(128, 64, 64)), 'floor']);
add([
  pos(20, 120),
  rect(600, 20),
  area(),
...
// Living room
add([pos(20, 140), rect(600, 300), color(rgb(64, 64, 128)), 'floor']);
add([pos(620, 20), rect(384, 420), color(rgb(64, 64, 128)), 'floor']);
add([
  pos(20, 440),
  rect(300, 20),
  area(),
...
// Kitchen
add([pos(320, 440), rect(100, 20), color(rgb(128, 128, 64)), 'floor']);
add([pos(20, 460), rect(600, 288), color(rgb(128, 128, 64)), 'floor']);
add([
  pos(620, 460),
  rect(20, 288),
  area(),
...
// Storage
add([pos(720, 440), rect(100, 20), color(rgb(64, 128, 64)), 'floor']);
add([pos(640, 460), rect(364, 288), color(rgb(64, 128, 64)), 'floor']);
...
onMousePress(() => {
  const flash = gun.add([
    pos(getSprite('gun').data.width * 1.5, Math.abs(gun.angle) > 90 ? 7 : -7),
    circle(10),
    color(YELLOW),
    opacity(0.5),
  ]);
  ...
  const hit = raycast(player.pos, dir, ['player']);
  if (hit) {
    const splatter = add([
      pos(hit.point),
      particles(
