...
[**obxia**](https://obxiajs.com/) is a JavaScript library that helps you make
games fast and fun!

Start playing around with it in the [obxiaGROUND](https://play.obxiajs.com/)
...
obxia uses a powerful component system to compose game objects and behaviors.
...
### Start a Project With `create-obxia`

The fastest way to start a obxia game is with
[`create-obxia`](https://github.com/obxiajs/create-obxia)

```sh
$ npx create-obxia mygame
```
...
```js
const kaboom = require('obxia');
```

Note that you'll need to use a bundler like `esbuild` or `webpack` to use obxia
with NPM

### Browser CDN

This exports a global `obxia` function

```html
<script src="https://unpkg.com/obxia@3000.1.17/dist/kaboom.js"></script>
<script>
  obxia();
</script>
```
...
```html
<script type="module">
  import obxia from 'https://unpkg.com/obxia@3000.1.17/dist/kaboom.mjs';
  obxia();
</script>
```
...
- [GitHub Discussions](https://github.com/obxiajs/obxia/discussions)
- [Twitter](https://twitter.com/Kaboomjs)

### Games

Collections of games made with obxia (and Kaboom), selected by obxia:

- [Itch.io](https://itch.io/c/4494863/kag-collection)
- [Newgrounds.com](https://www.newgrounds.com/playlist/379920/obxia-games)
...
- Thanks to [mulfok](https://twitter.com/MulfoK) for the amazing
  ...
  obxia sprites and art in general
