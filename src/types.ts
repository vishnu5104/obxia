...
> {
    ...
    * @group Components
     ...
     *
     * [Guide about fake mouse](https://obxiajs.com/guides/fake-mouse)
     */
     ...
     *     // predefined functions to get the default value by obxia
     *     return def_vert();
     * }`,
     ...
     * @group Plugins
     */
    plug<T extends Record<string, any>>(plugin: obxiaPlugin<T>): obxiaCtx & T;
    /**
    ...
    BLACK: Color;
    /**
     * The canvas DOM obxia is currently using.
     *
     * @group Info
     */
...
export type PluginList<T> = Array<T | obxiaPlugin<any>>;
...
/**
 * obxia configurations.
 *
 * @group Start
 */
export interface obxiaOpt<
...
> {
    ...
    /**
     * If obxia should render a default loading screen when assets are not fully ready (default true).
     *
     * @since v3000.0
     */
    ...
    focus?: boolean;
    /**
     * If import all obxia functions to global (default true).
     */
    global?: boolean;
    /**
 ...
 * @example
 * ```js
 * // a plugin that adds a new function to obxia
 * const myPlugin = (k) => ({
 *    myFunc: () => {
 ...
 * @group Plugins
 */
export type obxiaPlugin<T> = (
    k: obxiaCtx,
) => T | ((...args: any) => (k: obxiaCtx) => T);
...
export interface GameObjRaw {
    ...
    onKeyDown: obxiaCtx["onKeyDown"];
    onKeyPress: obxiaCtx["onKeyPress"];
    onKeyPressRepeat: obxiaCtx["onKeyPressRepeat"];
    onKeyRelease: obxiaCtx["onKeyRelease"];
    onCharInput: obxiaCtx["onCharInput"];
    onMouseDown: obxiaCtx["onMouseDown"];
    onMousePress: obxiaCtx["onMousePress"];
    onMouseRelease: obxiaCtx["onMouseRelease"];
    onMouseMove: obxiaCtx["onMouseMove"];
    onTouchStart: obxiaCtx["onTouchStart"];
    onTouchMove: obxiaCtx["onTouchMove"];
    onTouchEnd: obxiaCtx["onTouchEnd"];
    onScroll: obxiaCtx["onScroll"];
    onGamepadButtonDown: obxiaCtx["onGamepadButtonDown"];
    onGamepadButtonPress: obxiaCtx["onGamepadButtonPress"];
    onGamepadButtonRelease: obxiaCtx["onGamepadButtonRelease"];
    onGamepadStick: obxiaCtx["onGamepadStick"];
    onButtonDown: obxiaCtx["onButtonDown"];
    onButtonPress: obxiaCtx["onButtonPress"];
    onButtonRelease: obxiaCtx["onButtonRelease"];
}

/**
 * The basic unit of object in obxia. The player, a butterfly, a tree, or even a piece of text.
 *
 * @group Game Obj
 */
