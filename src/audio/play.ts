...
import { assets, audio } from "../obxia";
...
export interface AudioPlayOpt {
     ...
     * obxia's default volume node. Defaults to undefined, i.e. use obxia's volume node.
     */
    connectTo?: AudioNode;
}
...
export interface AudioPlay {
     ...
     * and connect it to the passed-in audio node, or to obxia's default volume node
