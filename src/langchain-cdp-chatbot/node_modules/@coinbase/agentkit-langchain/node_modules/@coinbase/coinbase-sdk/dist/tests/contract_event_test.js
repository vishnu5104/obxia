...
const contract_event_1 = require("../coinbase/contract_event");
describe("ContractEvent", () => {
    ...
    describe(".networkId", () => {
        it("should return the correct network ID", () => {
            const event = new contract_event_1.ContractEvent(eventData);
    ...
    describe(".txHash", () => {
        it("should return the correct transaction hash", () => {
            const event = new contract_event_1.ContractEvent(eventData);
            expect(event.txHash()).toEqual("0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef");
        });
    });
    describe(".txIndex", () => {
    ...
    describe(".data", () => {
        it("should return the correct event data", () => {
            const event = new contract_event_1.ContractEvent(eventData);
            expect(event.data()).toEqual('{"from":"0x1234...","to":"0x5678...","value":"1000000000000000000"}');
        });
    });
    describe(".toString", () => {
        it("should return the string representation of a contract event", () => {
            ...
            expect(eventStr).toEqual("ContractEvent { networkId: 'ethereum-mainnet' protocolName: 'uniswap' contractName: 'Pool' eventName: 'Transfer' contractAddress: '0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48' blockHeight: 201782330 txHash: '0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef' }");
        });
    });
});
