...
describe("Transaction", () => {
    ...
    describe("#isTerminalState", () => {
        [types_1.TransactionStatus.PENDING, types_1.TransactionStatus.BROADCAST, types_1.TransactionStatus.SIGNED].forEach(status => {
        ...
        [types_1.TransactionStatus.COMPLETE, types_1.TransactionStatus.FAILED].forEach(status => {
