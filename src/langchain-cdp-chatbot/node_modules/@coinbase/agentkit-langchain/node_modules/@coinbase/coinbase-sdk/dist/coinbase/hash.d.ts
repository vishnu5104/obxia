 ...
 */
export declare const hashMessage: (message: Uint8Array | string) => string;
/**
 ...
 */
export declare const hashTypedDataMessage: (domain: TypedDataDomain, types: Record<string, Array<TypedDataField>>, value: Record<string, any>) => string;
