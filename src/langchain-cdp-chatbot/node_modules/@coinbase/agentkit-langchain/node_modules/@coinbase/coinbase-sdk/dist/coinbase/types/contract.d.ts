 ...
 */
type MatchesParams<TArgs, TParams> = TArgs extends TParams ? TParams extends TArgs ? true : false : false;
/**
 * Matches the provided arguments to a specific function in the ABI.
 * Returns the matched AbiFunction if found, never otherwise.
 */
type MatchArgsToFunction<TAbi extends Abi, TFunctionName extends string, TArgs extends Record<string, string>> = ExtractAbiFunction<TAbi, TFunctionName> extends infer TFunctions ? TFunctions extends AbiFunction ? MatchesParams<TArgs, AbiParametersToDictionary<TFunctions["inputs"]>> extends true ? TFunctions : any : any : any;
/**
 ...
 */
export type ContractFunctionReturnType<TAbi extends Abi, TFunctionName extends ContractFunctionName<TAbi, "view" | "pure">, TArgs extends Record<string, string> = {}> = MatchArgsToFunction<TAbi, TFunctionName, TArgs> extends infer TFunction ? TFunction extends AbiFunction ? AbiParametersToPrimitiveTypes<TFunction["outputs"]> extends infer TOutputs ? TOutputs extends readonly [] ? void : TOutputs extends readonly [infer TOutput] ? TOutput : TOutputs : any : any : any;
export {};
