...
const read_contract_1 = require("../coinbase/read_contract");
...
describe("readContract", () => {
    ...
    describe("With an ABI", () => {
        it("should correctly read a uint8 value from a pure function", async () => {
            utils_1.smartContractApiMock.readContract.mockResolvedValue({
                data: {
                    type: "uint8",
                    value: "123",
                },
            });
            const result = await (0, read_contract_1.readContract)({
                networkId: "1",
            ...
            expect(utils_1.smartContractApiMock.readContract).toHaveBeenCalledWith("1", "0x1234567890123456789012345678901234567890", {
                method: "pureUint8",
                args: "{}",
